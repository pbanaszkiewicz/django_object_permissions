# BIG thanks to Ben Welsh (@palewire) for this script
#
# More:
...
class QuickDjangoTest(object):
    ...
    def _old_tests(self):
        ...
        """
        settings.configure(DEBUG = True, TESTING = True,
    ...
    def _new_tests(self):
        ...
        failures = DjangoTestSuiteRunner().run_tests(self.apps, verbosity=1, failfast=False)
        # if failures:
        #     sys.exit(failures)
...
if __name__ == '__main__':
    ...
    Example usage:
        ...
        $ python travis_test.py app1 app2
